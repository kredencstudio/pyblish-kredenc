...
@pyblish.api.log
class IntegrateEditReview(pyblish.api.InstancePlugin):
    ...
    def process(self, instance):
        ...
        if not 'Asset_Build' in instance.context.data['ftrackData']:
            ...
            review_path = instance.data['ftrackComponents']['review']['path']
            ...
            self.log.info('Copying EDIT PREVIEW from location: {}'.format(review_path))
            self.log.info('Copying EDIT PREVIEW to location: {}'.format(publishFile))
